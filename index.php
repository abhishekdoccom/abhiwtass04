<head>
    ...
    <body>
        <div class="jumbotron text-center"><h1 style="color: white;">hotal Menu</h1></div>
        ...
        <div class="cont">
          ...
          <div class="container">
            <select name="item hotal-dropdown hotal" class="custom-select custom-select-lg mb-3" id="hotal">
        ...
        <footer>
            <!-- <div class="footer1">
                <div class="container-fluid"> -->
                    ...
                    <a href="mailto:hotal@gmail.com">hotal@gmail.com</a></p>
                    <!-- </div>
              </div> -->
        </footer>
	...
	<script>
        let base_url = "hotal.php";
        
	$("document").ready(function(){
            gethotalMenuList();
            document.querySelector("#hotal").addEventListener("change",getMenuItemList);
        });
        function gethotalMenuList() {
            ...
            $.get(url,function(data,success){
              console.log(data)
                ...
                document.querySelector('#hotal').appendChild(opt);
            }
            });
        }
